...
fun thirdDigit(number: Int): Int {
    val new_number=(number%1000)/100
    return new_number
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val result_minutes = minutesArrive - minutesDepart
    val result_hours = hoursArrive - hoursDepart
    return (result_hours * 60) + result_minutes
}
...
fun numberRevert(number: Int): Int {
    val new_number1 = number / 100
    val new_number2 = (number / 10) % 10
    val new_number3 = number % 10
    val result = (new_number3 * 100) + (new_number2 * 10) + new_number1
    return result
}
